...
ProcesoPar_t *lanzarProcesoPar(const char *nombreArchivoEjecutable,
  ...
  if (procesoPar->hijo == 0) {
	...
	close(procesoPar->tuberia_out[1]) != 0) return nullptr;
  }
  return procesoPar;
}
